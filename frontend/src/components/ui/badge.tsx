...
const badgeVariants = {
  ...
  secondary: "inline-flex items-center rounded-full border border-transparent bg-ink-100 text-ink-900 px-2.5 py-0.5 text-xs font-semibold",
  ...
  outline: "inline-flex items-center rounded-full border border-ink-300 text-ink-900 px-2.5 py-0.5 text-xs font-semibold",
}
