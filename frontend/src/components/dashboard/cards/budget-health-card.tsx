    ...
    <DashboardCard cardId="budget-health" loading={loading} error={error}>
      {budgets.length === 0 ? (
        ...
        <>
          ...
          {topOverBudget && (
            <div className="mt-5 rounded-2xl border border-primary-200/50 bg-gradient-to-br from-primary-50/80 to-primary-50/40 p-4">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.1em] text-primary-600">
