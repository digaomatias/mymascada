...
import { CSVMappingReviewForReconciliation } from './csv-mapping-review-reconciliation';
import { BankTransaction } from './reconciliation-file-upload';
import { useTranslations } from 'next-intl';

interface AICSVUploadForReconciliationProps {
...
export function AICSVUploadForReconciliation({ 
  onTransactionsExtracted 
}: AICSVUploadForReconciliationProps) {
  const t = useTranslations('import.aiCsvReconciliation');
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      // Store results and move to mapping review
  ...
  // If we have analysis results, show the mapping review
  if (analysisResult && uploadedFile) {
    return (
      <CSVMappingReviewForReconciliation
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-900">{t('modeTitle')}</h4>
          ...
          <div className="text-xs text-gray-500 space-y-1">
            ...
            <p>{t('requirements.reconciliationOnly')}</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-4">
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              ...
              <li>{t('features.extractForComparison')}</li>
