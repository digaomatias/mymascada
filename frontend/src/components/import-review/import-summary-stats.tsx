      ...
      <Card className="bg-white border-0 shadow-sm">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="text-lg font-bold text-ink-900">{progress.total}</div>
              <div className="text-xs text-ink-500">{tImport('review.progress.total')}</div>
            </div>
            <div>
              <div className="text-lg font-bold text-blue-600">{progress.reviewed}</div>
              <div className="text-xs text-ink-500">{tImport('review.progress.reviewed')}</div>
            </div>
            <div>
              <div className="text-lg font-bold text-green-600">{progress.toImport}</div>
              <div className="text-xs text-ink-500">{tImport('review.progress.toImport')}</div>
            </div>
            <div>
              <div className="text-lg font-bold text-red-600">{progress.toSkip}</div>
              <div className="text-xs text-ink-500">{tImport('review.progress.toSkip')}</div>
            </div>
          </div>
