    ...
    <div className="min-h-screen bg-ink-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 sm:p-12 prose prose-gray max-w-none">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">What is MyMascada?</h2>
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">No Warranty</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Not Financial Advice</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Limitation of Liability</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Your Responsibilities</h2>
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Account Termination</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Data Handling</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">GDPR &amp; Data Protection</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Open Source</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Changes to These Terms</h2>
          <p className="text-ink-700 mb-4">
