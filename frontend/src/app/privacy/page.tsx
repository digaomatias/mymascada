    ...
    <div className="min-h-screen bg-ink-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 sm:p-12 prose prose-gray max-w-none">
          ...
          <p className="text-sm text-ink-500 mb-8">Last updated: February 2026</p>

          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Overview</h2>
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Data We Store</h2>
          <p className="text-ink-700 mb-2">
            When you create an account and use MyMascada, the following data is stored in our database:
          </p>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-2">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Telemetry</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Third-Party Services</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h3 className="text-lg font-semibold text-ink-900 mt-6 mb-3">Akahu (Bank Syncing &mdash; New Zealand)</h3>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-1">
          ...
          <h3 className="text-lg font-semibold text-ink-900 mt-6 mb-3">Google OAuth (Sign-In)</h3>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-1">
          ...
          <h3 className="text-lg font-semibold text-ink-900 mt-6 mb-3">OpenAI API (AI Features)</h3>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-1">
          ...
          <h3 className="text-lg font-semibold text-ink-900 mt-6 mb-3">Stripe (Payment Processing)</h3>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-1">
          ...
          <h3 className="text-lg font-semibold text-ink-900 mt-6 mb-3">Email Provider (Transactional Emails)</h3>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-1">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Data Retention</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Your Rights</h2>
          <ul className="list-disc pl-6 text-ink-700 mb-4 space-y-2">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">GDPR &amp; European Users</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Security</h2>
          <p className="text-ink-700 mb-4">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mt-8 mb-4">Changes to This Policy</h2>
          <p className="text-ink-700 mb-4">
